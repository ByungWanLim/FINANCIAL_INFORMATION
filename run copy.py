...
"""+"""
이제 진짜로 한번 해봐. 
당신은 제 Q&A 도우미가 될 것입니다.
위의 Context와 예를 참조하여 질문에 대한 답을 한 문장으로 출력하세요.
이때, 답변을 쓰는 ​​데에는 규칙이 있습니다. 이 규칙을 따라야 합니다.
규칙 1: Context 정보를 충분히 고려하여 답변을 쓰세요.
규칙 2: 답변에는 "Context"나 "Source"가 포함되지 않습니다.
규칙 3: 답변은 가능한 한 간결하게 한 문장으로 작성해야 합니다.
규칙 4: 답변에서 "답변:", "Answer:"와 같은 문구는 제외합니다.
규칙 5: 규칙 3에 언급된 문구 외에도 답변과 관련이 없는 문구는 제외합니다.
규칙 6: 답변 형식은 A is B를 따르는 한 문장입니다.
규칙 7: 답변은 한국어로 작성해야 합니다.
